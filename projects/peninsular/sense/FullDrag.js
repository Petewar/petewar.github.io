(function () {
    ...
    function loadVideoFirstFramesComplete(evt) {
        ...
        var customEvent = new createjs.Event("fullDragLoadComplete");
            ...
            customEvent.contentLoaded = videoFirstFrames;
            instanceDispatch.dispatchEvent(customEvent);

        createProjects(videoFirstFrames,container);
    ...
    function createProjects(Iprojects,Icontainer){
        ...
        for(var i=lengthProjects;i>-1;i--){
           ...
           aspectRatio.resize(projectContainer,1920,1080)
     ...
     */    
     ...
     p.resize = function() {
        ...
        for(var i=0;i<lengthProjects;i++){
            ...
            aspectRatio.resize(container.getChildByName("Project"+i),1920,1080);
