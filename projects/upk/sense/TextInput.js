...
class TextInput extends createjs.Container {
  ...
  setRatio(Iratio,posX,posY){
    ...
    // Field Settings
    this.width = 380*Iratio;
    this.height = 20*Iratio;

    // Text Settings
    this.placeHolder = '';
    this.placeHolderTextColor = '#000000';
    this.textColor = '#000000';
    this.fontSize = 14*Iratio;
  ...
  _setupPlaceHolderText() {
    ...
    if (this._placeHolderText === null) {
      ...
      this._placeHolderText.textAlign = "left";
  ...
  _setupVisibleText() {
    ...
    if (this._visiblePreCursorText === null) {
      ...
      this._visiblePreCursorText.textAlign = "left";
    ...
    if (this._visiblePostCursorText === null) {
      ...
      this._visiblePostCursorText.textAlign = "left";
  ...
  _setupListeners() {
    ...
    this._hiddenInput.addEventListener('input', (e) => {
      if (this._focused) {
        ...
        this.update();
        this._cursor.x = this._visiblePreCursorText.getMeasuredWidth()*this.ratio;
        this._cursor.y = 3*this.ratio;
      }
    });
