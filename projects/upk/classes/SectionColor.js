(function () {
    ...
    function SectionColor(Iratio,Image,Ititle,IaspectRatio,IposY) {
    ...
    var p = createjs.extend(SectionColor, createjs.Container);
...
window.SectionColor = createjs.promote(SectionColor, "Container");
}());