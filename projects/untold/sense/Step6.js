(function () {
    ...
    function Step6(Iratio,Iinstance) {
    ...
    var numberTwoTxt;
    var ofTxt;
    var numberOneText = "06";
    var numberTwoText = "06";
    var ofText = "of";
    var initValue = 400;
    var titleInputTxt;
    var titleInputText = "This is The Step, We Need Your @";
    var titleTxt;
    var titleText = "Your Email To Get it Started";
    var strokeFill;
    ...
    var p = createjs.extend(Step6, createjs.Container);

    p.setup = function() {
       instance = this;
        dispatchInstance = this.dispatchInstance;
        ratio = this.ratio;
        console.log("Step6 Contact");
        createStep();
    };
...
window.Step6 = createjs.promote(Step6, "Container");
}());