(function () {
    ...
    function Step5(Iratio,Iinstance) {
    ...
    var numberTwoTxt;
    var ofTxt;
    var numberOneText = "05";
    var numberTwoText = "06";
    var ofText = "of";
    var initValue = 400;
    var titleInputTxt;
    var titleInputText = "I am Looking To Stay Around";
    var titleTxt;
    var titleText = "Your Budget";
    var strokeFill;
    ...
    var p = createjs.extend(Step5, createjs.Container);

    p.setup = function() {
        instance = this;
        dispatchInstance = this.dispatchInstance;
        ratio = this.ratio;
        console.log("Step5 Contact");
        createStep();
    };
...
window.Step5 = createjs.promote(Step5, "Container");
}());