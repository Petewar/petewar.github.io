(function () {
    ...
    function Step4(Iratio,Iinstance) {
    ...
    var numberTwoTxt;
    var ofTxt;
    var numberOneText = "04";
    var numberTwoText = "06";
    var ofText = "of";
    var initValue = 400;
    var titleInputTxt;
    var titleInputText = "I Would Need it For Yesterday";
    var titleTxt;
    var titleText = "Your Deadline or Date";
    var strokeFill;
    ...
    var p = createjs.extend(Step4, createjs.Container);

    p.setup = function() {
        instance = this;
        dispatchInstance = this.dispatchInstance;
        ratio = this.ratio;
        console.log("Step4 Contact");
        createStep();
    };
...
window.Step4 = createjs.promote(Step4, "Container");
}());