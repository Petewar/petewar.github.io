(function () {
    ...
    function Step2(Iratio,Iinstance) {
    ...
    var numberTwoTxt;
    var ofTxt;
    var numberOneText = "02";
    var numberTwoText = "06";
    var ofText = "of";
    var initValue = 400;
    var titleInputTxt;
    var titleInputText = "I'm Rocking At";
    var titleTxt;
    var titleText = "Your Organization Name";
    var strokeFill;
    ...
    var p = createjs.extend(Step2, createjs.Container);

    p.setup = function() {
        instance = this;
        dispatchInstance = this.dispatchInstance;
        ratio = this.ratio;
        console.log("Step2 Contact");
        createStep();
    };
...
window.Step2 = createjs.promote(Step2, "Container");
}());